                            ...
                            return (
                                ...
                                >
                                    ...
                                    <motion.div
                                        ...
                                        className="absolute left-0 top-5 sm:top-6 w-3.5 h-3.5 sm:w-4 sm:h-4 rounded-full bg-background border-2 border-purple-500 transition-colors z-10"
                                    />

                                    {/* Card */}
                                    <div
                                        className={`glass-morphism rounded-xl sm:rounded-2xl transition-all duration-300 overflow-hidden border ${isOpen
                                    ...
                                    >
                                        ...
                                        <div className="p-4 sm:p-5 flex items-start sm:items-center gap-3 sm:gap-4">
                                            <div className={`w-9 h-9 sm:w-11 sm:h-11 rounded-lg sm:rounded-xl flex items-center justify-center shrink-0 transition-colors duration-300 mt-0.5 sm:mt-0 ${isOpen ? "bg-purple-600/15 dark:bg-purple-500/15" : "bg-muted dark:bg-white/5"
                                                }`}>
